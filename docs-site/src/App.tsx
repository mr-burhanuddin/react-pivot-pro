...
export const routes: DocRoute[] = [
  ...
  {
    path: '/column-features',
    title: 'Column Features',
    description: 'Column visibility, ordering, and pinning for flexible layouts.',
    headings: ['Visibility', 'Ordering', 'Pinning'],
    category: 'Features',
  },
  {
    path: '/drag-drop',
    title: 'Drag & Drop',
    description: 'Reorder rows and columns with drag-and-drop functionality.',
    headings: ['Row DnD', 'Column DnD', 'State persistence'],
    category: 'Features',
  },
  {
    path: '/utilities',
    title: 'Utilities',
    description: 'Export, clipboard, and aggregation utilities.',
    headings: ['CSV export', 'Clipboard', 'Fullscreen'],
    category: 'Features',
  },
  {
    path: '/fullscreen',
    title: 'Fullscreen',
    description: 'Toggle fullscreen mode for tables and containers.',
    headings: ['Live demo', 'Usage', 'API'],
    category: 'Features',
  },
  // Advanced
  {
...
const pageModules: Record<string, LazyExoticComponent<DocPageComponent>> = {
  ...
  '/column-features': lazy(() => import('@/pages/column-features')),
  '/drag-drop': lazy(() => import('@/pages/drag-drop')),
  '/utilities': lazy(() => import('@/pages/utilities')),
  '/fullscreen': lazy(() => import('@/pages/fullscreen')),
