...
const PAGE_MODULES: Record<string, PageComponent> = {
  ...
  "/contributing/plugin-authoring": lazy(
    () => import("./pages/contributing-plugin-authoring"),
  ),
  "/contributing/changelog": lazy(
    () => import("./pages/contributing-changelog"),
  ),
};
