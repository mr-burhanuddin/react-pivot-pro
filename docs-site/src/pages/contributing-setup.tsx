...
export default function ContributingSetup() {
  return (
    <DocPage title="Development Setup" subtitle="Get your local environment ready for contributing to react-pivot-pro">
      <h2>Prerequisites</h2>
      <ul>
        <li>Node.js 18+</li>
        <li>npm 9+</li>
      ...
      <pre><code>{`git clone https://github.com/your-org/react-pivot-pro.git
cd react-pivot-pro
npm install`}</code></pre>
      ...
      <table>
        ...
        <tbody>
          <tr><td><code>npm run build</code></td><td>Build the library (outputs to dist/)</td></tr>
          <tr><td><code>npm run dev</code></td><td>Watch mode for development</td></tr>
          <tr><td><code>npm run build:types</code></td><td>Build types only</td></tr>
          <tr><td><code>npm run typecheck</code></td><td>TypeScript type checking (no emit)</td></tr>
          <tr><td><code>npm run lint</code></td><td>Run ESLint</td></tr>
          <tr><td><code>npm run test</code></td><td>Run all tests in watch mode</td></tr>
          <tr><td><code>npm run test:run</code></td><td>Run all tests once (CI mode)</td></tr>
          <tr><td><code>npm run clean</code></td><td>Clean dist folder</td></tr>
          <tr><td><code>npm run docs:dev</code></td><td>Start docs site locally</td></tr>
        </tbody>
      </table>
...
└── src/
    ...
    └── App.tsx        # Router and layout`}</code></pre>
