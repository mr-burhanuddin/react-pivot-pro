...
export interface UseVirtualColumnsResult<
  TScrollElement extends Element | Window = Element,
  TItemElement extends Element = Element,
> {
...
export function useVirtualColumns<
  ...
  TItemElement extends Element = Element,
>(
  options: UseVirtualColumnsOptions<TScrollElement, TItemElement>,
): UseVirtualColumnsResult<TScrollElement, TItemElement> {
